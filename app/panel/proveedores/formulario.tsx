...
export function FormularioProveedor() {
  ...
  return (
    <form action={accion} className="grid gap-3 sm:grid-cols-2">
      <input name="nombre" placeholder="Nombre" required className="rounded-lg border border-stone-300 px-3 py-2 text-sm outline-none focus:border-sky-600" />
      <input name="rubro" placeholder="Rubro (ej: lavandería)" className="rounded-lg border border-stone-300 px-3 py-2 text-sm outline-none focus:border-sky-600" />
      <input name="cuit" placeholder="CUIT" className="rounded-lg border border-stone-300 px-3 py-2 text-sm outline-none focus:border-sky-600" />
